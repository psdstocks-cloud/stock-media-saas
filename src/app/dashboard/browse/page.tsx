                        ...
                        onError={(e) => {
                          ...
                          if (site === 'dreamstime') {
                            ...
                            const alternatives = [
                              ...
                              `https://elements-cover-images-0.imgix.net/${id}/cover.jpg?w=400&h=300&fit=crop&q=85&format=jpeg`,
                              `https://elements-cover-images-1.imgix.net/${id}/cover.jpg?w=400&h=300&fit=crop&q=85&format=jpeg`,
                              `https://elements-cover-images-2.imgix.net/${id}/cover.jpg?w=400&h=300&fit=crop&q=85&format=jpeg`,
                              `https://elements-cover-images-3.imgix.net/${id}/cover.jpg?w=400&h=300&fit=crop&q=85&format=jpeg`,
                              `https://elements-cover-images-4.imgix.net/${id}/cover.jpg?w=400&h=300&fit=crop&q=85&format=jpeg`,
                              `https://elements-cover-images-5.imgix.net/${id}/cover.jpg?w=400&h=300&fit=crop&q=85&format=jpeg`,
                              `https://elements-cover-images-6.imgix.net/${id}/cover.jpg?w=400&h=300&fit=crop&q=85&format=jpeg`,
                              `https://elements-cover-images-7.imgix.net/${id}/cover.jpg?w=400&h=300&fit=crop&q=85&format=jpeg`,
                              `https://elements-cover-images-8.imgix.net/${id}/cover.jpg?w=400&h=300&fit=crop&q=85&format=jpeg`,
                              `https://elements-cover-images-9.imgix.net/${id}/cover.jpg?w=400&h=300&fit=crop&q=85&format=jpeg`,
                              `https://elements-cover-images-0.imgix.net/${id}/thumbnail.jpg?w=400&h=300&fit=crop&q=85&format=jpeg`,
                              `https://elements-cover-images-1.imgix.net/${id}/thumbnail.jpg?w=400&h=300&fit=crop&q=85&format=jpeg`,
                              `https://elements-cover-images-2.imgix.net/${id}/thumbnail.jpg?w=400&h=300&fit=crop&q=85&format=jpeg`,
                              `https://elements-cover-images-3.imgix.net/${id}/thumbnail.jpg?w=400&h=300&fit=crop&q=85&format=jpeg`,
                              `https://elements-cover-images-4.imgix.net/${id}/thumbnail.jpg?w=400&h=300&fit=crop&q=85&format=jpeg`,
                              `https://elements-cover-images-5.imgix.net/${id}/thumbnail.jpg?w=400&h=300&fit=crop&q=85&format=jpeg`,
                              `https://elements-cover-images-6.imgix.net/${id}/thumbnail.jpg?w=400&h=300&fit=crop&q=85&format=jpeg`,
                              `https://elements-cover-images-7.imgix.net/${id}/thumbnail.jpg?w=400&h=300&fit=crop&q=85&format=jpeg`,
                              `https://elements-cover-images-8.imgix.net/${id}/thumbnail.jpg?w=400&h=300&fit=crop&q=85&format=jpeg`,
                              `https://elements-cover-images-9.imgix.net/${id}/thumbnail.jpg?w=400&h=300&fit=crop&q=85&format=jpeg`,
                              `https://elements-resized.envatousercontent.com/elements-cover-images/${id}?w=400&h=300&cf_fit=crop&q=85&format=jpeg`,
                              `https://elements-resized.envatousercontent.com/elements-cover-images/${id}?w=300&h=200&cf_fit=crop&q=85&format=jpeg`,
                              `https://elements-resized.envatousercontent.com/elements-cover-images/${id}?w=200&h=150&cf_fit=crop&q=85&format=jpeg`
                            ]
