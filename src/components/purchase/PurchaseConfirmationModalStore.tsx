...
export const PurchaseConfirmationModalStore: React.FC = () => {
  const { 
  ...
  const media = selectedItemForPurchase

  const handleConfirm = async () => {
    try {
      await confirmPurchase(media)
    } catch (error) {
        ...
        <div className="space-y-6">
          ...
          <div className="flex space-x-3 pt-4">
            ...
            <Button
              ...
              disabled={!canAfford || isProcessingPurchase}
              className="flex-1"
            >
...
export default PurchaseConfirmationModalStore
