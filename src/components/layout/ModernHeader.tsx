        ...
        <div className="mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center space-x-8">
              ...
              >
                <div className="w-8 h-8 bg-gradient-to-tr from-orange-500 to-orange-600 rounded-lg flex items-center justify-center shadow-sm group-hover:shadow-md transition-shadow">
                  ...
                  {navigationItems.map((item) => {
                    ...
                    return (
                      <Link
                        ...
                        href={item.href}
                        className={`
                          group relative flex items-center space-x-2 px-3 py-2 rounded-lg text-sm font-medium transition-all duration-200 nav-item
                          ${isActive 
                            ? 'bg-orange-50 text-orange-700 shadow-sm active' 
              ...
              <div className="hidden md:flex flex-1 max-w-lg mx-8">
                <div className="relative w-full">
                  ...
                  <Input
                    ...
                    className="pl-10 bg-gray-50 border-gray-200 focus:bg-white transition-colors command-palette"
                  />
              ...
              {isLoading ? (
                ...
                <>
                  ...
                  <div className="hidden lg:flex items-center space-x-3">
                    ...
                    {/* Notifications */}
                    <Button variant="ghost" size="sm" className="relative micro-bounce">
                      <Bell className="h-4 w-4" />
                      {notifications > 0 && (
                        <Badge className="absolute -top-1 -right-1 h-5 w-5 p-0 text-xs notification-pulse">
                          {notifications}
                        </Badge>
                      )}
                    </Button>
                    ...
                    <DropdownMenu>
                      <DropdownMenuTrigger asChild>
                        <Button size="sm" className="bg-orange-600 hover:bg-orange-700 micro-bounce">
                      ...
                      <DropdownMenuContent align="end" className="w-48">
                        ...
                        <DropdownMenuItem asChild>
                          <Link href="/dashboard/subscription" className="flex items-center space-x-2">
                            <CreditCard className="h-4 w-4" />
                            <span>Upgrade Plan</span>
                          </Link>
                        </DropdownMenuItem>
                        <DropdownMenuItem asChild>
                          <Link href="/dashboard/api-keys" className="flex items-center space-x-2">
                        ...
                        <DropdownMenuLabel>
                          <div className="flex items-center space-x-3">
                            ...
                            <div>
                              ...
                              <div className="text-xs text-gray-500">{userPoints} points</div>
                            </div>
                          </div>
                        </DropdownMenuLabel>
                        <DropdownMenuSeparator />
                  ...
                  <div className="hidden lg:block">
                    <DropdownMenu>
                      <DropdownMenuTrigger asChild>
                        <Button variant="ghost" className="flex items-center space-x-2 h-9 micro-bounce">
                          <div className="w-7 h-7 bg-gradient-to-r from-orange-500 to-orange-600 rounded-full flex items-center justify-center">
                            <User className="h-4 w-4 text-white" />
                          </div>
                ...
                <div className="flex items-center space-x-3">
                  <Link href="/login">
                    <Button variant="outline" size="sm" className="micro-bounce">Sign In</Button>
                  </Link>
                  <Link href="/register">
                    <Button size="sm" className="bg-orange-600 hover:bg-orange-700 micro-bounce">
                      Get Started
          ...
          {isDashboardArea && isAuthenticated && activeItem && (
            <div className="border-t border-gray-100 py-2 hidden lg:block">
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-4">
                  <div className="flex items-center space-x-2 text-sm">
                    <activeItem.icon className="h-4 w-4 text-orange-600" />
