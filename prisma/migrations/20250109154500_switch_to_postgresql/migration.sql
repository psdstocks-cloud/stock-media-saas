...
-- CreateEnum
CREATE TYPE "PointsHistoryType" AS ENUM ('SUBSCRIPTION', 'PURCHASE', 'ROLLOVER', 'DOWNLOAD', 'REFUND', 'BONUS', 'ADMIN_ADJUSTMENT');

-- CreateEnum
CREATE TYPE "OrderStatus" AS ENUM ('PENDING', 'PROCESSING', 'READY', 'COMPLETED', 'FAILED', 'CANCELED', 'REFUNDED');
...
CREATE TABLE "points_history" (
    "id" TEXT NOT NULL,
    "userId" TEXT NOT NULL,
    "type" "PointsHistoryType" NOT NULL,
